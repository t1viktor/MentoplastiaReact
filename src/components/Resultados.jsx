        ...
        <div id="resultados" className="min-h-screen bg-gray-900 flex flex-col items-center px-3 space-y-20 py-12">
            ...
            <div className="grid grid-cols-2 max-lg:grid-cols-1 justify-items-center items-center gap-12">
                <div className="space-y-12 justify-items-center items-center">
                    <h2 className="text-blue-500 text-4xl">Transformação Facial</h2>
                    <p className="text-gray-50 text-center">Os resultados da mentoplastia começam a ser percebidos após a redução do inchaço, com a evolução total em até 6 meses após o procedimento.</p>
                    <ul className="text-gray-50 space-y-5">
                        <li className="relative before:content-['✔']">Queixo mais definido e harmonioso</li>
                        <li className="relative before:content-['✔']">Melhora no equilíbrio facial</li>
